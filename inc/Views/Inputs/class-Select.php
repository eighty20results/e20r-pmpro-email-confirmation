...
class Select {
	...
	public static function jsPath( $paths ) {
		...
		wp_enqueue_script( 'select2',
			Email_Confirmation_Shortcode::$LIBRARY_URL . "/includes/select2/dist/js/select2.js",
			array( 'jquery' ),
			Email_Confirmation_Shortcode::VERSION
		);
		wp_enqueue_style( 'select2',
			Email_Confirmation_Shortcode::$LIBRARY_URL . "/includes/select2/dist/css/select2.css",
			null,
			Email_Confirmation_Shortcode::VERSION
		);
